...
function MiningRigRental({ onCall, mrrClient, setMrrClient }) {
  ...
  return (
    <div className="rig-section mrr-theme" style={{ marginTop: '30px', borderTop: '1px solid #444', paddingTop: '20px' }}>
      ...
      <div className="button-group" style={{ marginTop: '10px' }}>
        ...
        <button className="btn-pro secondary" onClick={() => onCall('/api/v2/mrr/algos', { query: { client: mrrClient } })}>Algos</button>
        <button className="btn-pro secondary" onClick={() => onCall('/api/v2/mrr/profiles', { query: { client: mrrClient } })}>Profiles</button>
        <button className="btn-pro secondary" onClick={() => onCall('/api/v2/mrr/rentals', { query: { client: mrrClient } })}>Rentals</button>
      </div>
      ...
      <div className="market-inputs" style={{ marginTop: '15px' }}>
        ...
        <button className="btn-pro secondary" disabled={!rigId.trim()} onClick={() => onCall(`/api/v2/mrr/rig/${encodeURIComponent(rigId.trim())}/info`, { query: { client: mrrClient } })}>Get Rig Info</button>
        <button className="btn-pro secondary" disabled={!rigId.trim()} onClick={() => onCall(`/api/v2/mrr/rig/${encodeURIComponent(rigId.trim())}/pool`, { query: { client: mrrClient } })}>Get Pools</button>
      </div>
