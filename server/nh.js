...
export const getNiceHashApp = (client) => ({
  ...
  hashpower: {
    ...
    getOrderPrice: (query) => client.call({ method: 'GET', path: '/main/api/v2/hashpower/calculatePrice', query }),
    getBusinessOrder: (query) => client.call({ method: 'GET', path: '/main/api/v2/hashpower/calculatePrice', query }),
