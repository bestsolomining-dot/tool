...
export default function Dashboard({
  ...
  return (
    <div className="app-shell" style={{ padding: '0 20px 40px', maxWidth: '1600px', margin: '0 auto' }}>
      ...
      {/* POOLS SECTION */}
      <section className="pools-section" style={{
        marginBottom: '15px',
        marginTop: '0px',
      ...
      <Modal
        ...
        onClose={() => dispatch({ type: 'SET_MODAL', payload: { content: null, open: false } })}
      ...
      >
        ...
        <div className="modal-actions" style={{ marginTop: '12px' }}>
          <button className="btn-pro secondary" onClick={() => dispatch({ type: 'CLEAR_DEBUG_LOGS' })}>
            Clear Logs
          </button>
        </div>
      </Modal>
