...
export default function Login({ onLoginSuccess, onCall }) {
  ...
  return (
    <div className="app-shell" style={{ 
      ...
      <div className="panel" style={{ textAlign: 'center', padding: '40px', maxWidth: '400px', width: '100%' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button type="submit" className="btn-pro primary" disabled={loading} style={{ marginTop: '12px' }}>
